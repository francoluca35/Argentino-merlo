						...
						<div className="relative z-20 mx-1 flex w-13 shrink-0 items-center justify-center sm:mx-2 sm:w-16 md:mx-3 md:w-20 lg:mx-5 lg:w-24 xl:mx-6 xl:w-28">
							...
							>
								<Image
									...
									width={160}
									height={160}
									className="h-14 w-14 rounded-full object-contain shadow-[0_8px_28px_rgba(0,0,0,0.35)] ring-[0px] ring-white/90 sm:h-17 sm:w-17 md:h-21 md:w-21 lg:h-24 lg:w-24 xl:h-23 xl:w-23"
