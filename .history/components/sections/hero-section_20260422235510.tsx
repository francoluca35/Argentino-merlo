	...
	return (
		...
		>
			...
			<div className="relative z-[2] mx-auto grid w-full max-w-[1300px] flex-1 grid-cols-1 items-end gap-10 px-6 pb-10 pt-36 sm:px-10 sm:pt-40 lg:grid-cols-[minmax(0,1fr)_minmax(180px,240px)_320px] lg:gap-10 lg:px-16 lg:pt-44 xl:px-20">
				...
				<div className="animate-fade-up-delay-200 hidden items-center justify-center lg:flex">
					<Image
						src="/logo-oficial.png"
						alt="Escudo oficial Club Atlético Argentino de Merlo"
						width={420}
						height={420}
						className="h-auto w-full max-w-[230px] object-contain drop-shadow-[0_0_34px_rgba(0,174,239,0.5)]"
						priority
						sizes="230px"
					/>
				</div>
