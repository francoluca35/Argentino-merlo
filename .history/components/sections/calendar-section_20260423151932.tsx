...
const timelineItems = [
	...
	{
		year: "Siempre",
		title: "Siempre Argentino",
		desc: "Del barrio a cada cancha del país. Llevamos nuestros colores con orgullo y humildad.",
				...
				<div className="grid grid-cols-1 gap-10 lg:grid-cols-2 lg:gap-14">
					...
					<div className="flex flex-col gap-5">
						<div className="relative overflow-hidden rounded-2xl shadow-[0_12px_40px_rgba(0,30,80,0.18)]">
							<Image
								src="https://images.unsplash.com/photo-1522778526097-ce0a22ceb253?w=1400&q=80"
