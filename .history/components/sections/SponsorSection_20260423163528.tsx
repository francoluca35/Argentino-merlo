...
const sponsors = [
  {
    name: "Dimona",
    subtitle: "Marca",
    img: "/assets/sponsors/dimona.png",
    scale: "scale-[1.55]",
  },
  { name: "Solo Deportes", subtitle: "Main Sponsor", img: "/assets/sponsors/solo.png" },
  {
    name: "Pintureria fiorentino",
    subtitle: "Marca",
    img: "/assets/sponsors/pintu.png",
    scale: "scale-[1.3]",
  },
  { name: "Farmacia Palmar", subtitle: "Farmacia", img: "/assets/sponsors/PL.png" },
  { name: "Municipalidad Merlo", subtitle: "Municipalidad", img: "/assets/sponsors/muni.png" },
  {
    name: "Taffo Herrajes",
    subtitle: "Herrajes",
    img: "/assets/sponsors/taffo.png",
    scale: "scale-[1.75]",
  },
  {
    name: "El Super",
    subtitle: "Hormigonera",
    img: "/assets/sponsors/super.png",
    scale: "scale-[1.7]",
  },
  {
    name: "Sabri Textil",
    subtitle: "Fabrica de textil",
    img: "/assets/sponsors/textil.png",
    scale: "scale-[1.8]",
  },
];
                ...
                >
                  <div className="relative mb-2 flex h-14 w-full items-center justify-center grayscale transition-all duration-300 hover:grayscale-0">
                    <Image
                      ...
                      width={120}
                      height={48}
                      className={`max-h-14 w-auto max-w-full object-contain ${sponsor.scale ?? ""}`}
                    />
                  </div>
                  {/* Reflection effect */}
                  <div
                  ...
                  >
                    <Image
                      ...
                      width={120}
                      height={48}
                      className={`max-h-6 w-auto max-w-full -scale-y-100 object-contain blur-[1px] ${sponsor.scale ?? ""}`}
                    />
                  </div>
                </div>
              ))}
